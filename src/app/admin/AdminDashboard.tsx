...
export function AdminDashboard() {
  ...
  return (
    <div className="flex w-full max-w-6xl flex-col gap-5">
      {/* Sim, settings, resets, secret all moved to the global Admin
          drawer (top-center pill). This page now hosts only the song
          scheduler — too wide to fit in the drawer cleanly. */}
      <Card title="Pool source">
        <div className="rounded-xl bg-stone-100 p-3 font-mono text-sm">
          {DAILY_POOL.length} tracks from NOW That&rsquo;s What I Call Music
        </div>
      </Card>
